...
public:
	static void Init();
	static void EmitCircle(sf::Vector2f pos, float startSpeed, float maxSpeed, float acc, float timeToLiveInSeconds, float scaleRateChange, int numParticles, int randRotRange);
